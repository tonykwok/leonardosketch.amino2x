 ...
 */
public class SDLHorizontalLinearGradient extends LinearGradient implements SDLSurfacePaint {
    private int start;
    private int end;
    private SDL_Surface _texture;

    public SDLHorizontalLinearGradient(int start, int end) {
        this.start = start;
        this.end = end;
    }
        ...
        if(_texture == null) {
            ...
            for(int i=1; i<values.size(); i++) {
                ...
                for(int j=0; j<spanLength; j++) {
                    ...
                    SDL.setPixel(surface2,currentIndex+j,0,sdlcolor);
                }
